...
def on_doctype_update():
    frappe.db.add_index("School Schedule", fields=["school_calendar", "school"], index_name="idx_schedule_cal_school")
...
def get_first_academic_term_start(school_calendar):
    ...
    terms = frappe.get_all(
        "Term", filters={"academic_year": academic_year, "term_type": "Academic"}, fields=["term_start_date"]
    )
