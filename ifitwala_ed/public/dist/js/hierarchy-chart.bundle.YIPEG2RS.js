(() => {
  ...
  // ../ifitwala_ed/node_modules/html2canvas/dist/html2canvas.js
  var require_html2canvas = __commonJS({
    "../ifitwala_ed/node_modules/html2canvas/dist/html2canvas.js"(exports, module) {
  ...
  // ../ifitwala_ed/ifitwala_ed/public/js/hierarchy_chart/hierarchy_chart_desktop.js
  ...
  ifitwala_ed.HierarchyChart = class {
    ...
    show() {
      ...
      $(`[data-fieldname="organization"] .link-field`).css("z-index", 2);
    }
    setup_actions() {
      let me = this;
    ...
    get_all_nodes() {
      ...
      return new Promise((resolve) => {
        frappe.call({
          method: "ifitwala_ed.utilities.hierarchy_chart.get_all_nodes",
          args: {
            method: me.method,
            organization: me.organization
          },
  ...
  // ../ifitwala_ed/ifitwala_ed/public/js/hierarchy_chart/hierarchy_chart_mobile.js
