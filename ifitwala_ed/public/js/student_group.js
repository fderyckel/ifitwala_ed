...
// Renders a student card with Tailwind styling
export function renderStudentCard(student, options = {}) {
  ...
  const img_src = student.student_image || "/assets/ifitwala_ed/images/default_student_image.png";
  ...
  if (student.birth_date) {
    try {
      ...
      console.warn("Invalid birth_date for", student.student, e);
    }
  }
  ...
  return `
    <div class="bg-white rounded-xl p-4 text-center shadow hover:-translate-y-1 transition-transform duration-200">
      <a href="/app/student/${student_id}" target="_blank" rel="noopener">
        <img src="${img_src}"
          onerror="this.onerror=null;this.src='/assets/ifitwala_ed/images/default_student_image.png';"
          class="w-20 h-20 rounded-full object-cover mx-auto bg-gray-100"
          loading="lazy">
      </a>
...
// image.js – Smart fallback logic for student images
...
// Matches slugify behavior from Python for consistent image filenames
