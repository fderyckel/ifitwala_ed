...
# ifitwala_ed/assessment/api/gradebook/endpoints.py

"""
Gradebook endpoint implementation behind the public root RPC facade.

The stable Frappe method paths remain under ``ifitwala_ed.api.gradebook``.
This module owns the endpoint wiring so gradebook implementation tests can
exercise the assessment-owned boundary directly.
"""
...
from ifitwala_ed.assessment.api import outcome_publish
from ifitwala_ed.assessment.api.gradebook import reads as gradebook_reads
from ifitwala_ed.assessment.api.gradebook import support as gradebook_support
from ifitwala_ed.assessment.api.gradebook import writes as gradebook_writes
