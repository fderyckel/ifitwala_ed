          ...
          <DialogPanel class="if-overlay__panel">
            ...
            <div class="if-overlay__body px-6 pb-6 space-y-5">
              ...
              <div class="rounded-2xl border border-border/70 bg-white px-4 py-4 shadow-soft">
                <p class="type-body text-ink/80">
                  {{ __('Please confirm that all details are accurate. You will not be able to edit after submission.') }}
                </p>
              </div>
            </div>
            ...
            <div class="if-overlay__footer px-6 pb-6 flex flex-wrap items-center justify-between gap-3">
              <p class="type-caption text-ink/55">
                {{ isReadOnly ? __('This application is read-only.') : __('You can submit once you are ready.') }}
              </p>
...
const props = defineProps<{ open: boolean; zIndex?: number; overlayId?: string; readOnly?: boolean }>()
