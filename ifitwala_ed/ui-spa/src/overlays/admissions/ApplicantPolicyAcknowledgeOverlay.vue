        ...
        >
          <DialogPanel class="if-overlay__panel">
            <div class="if-overlay__header px-6 pt-6">
              <div class="min-w-0">
                <DialogTitle class="type-h2 text-ink">{{ policyName || __('Policy acknowledgement') }}</DialogTitle>
            ...
            <div class="if-overlay__body px-6 pb-6 space-y-5">
              ...
              >
                ...
                <p class="mt-1 type-caption text-rose-900/80 whitespace-pre-wrap">{{ errorMessage }}</p>
              </div>
            ...
            <div class="if-overlay__footer px-6 pb-6 flex flex-wrap items-center justify-between gap-3">
              <p class="type-caption text-ink/55">
                {{ isReadOnly ? __('This application is read-only.') : __('Acknowledgements are permanent.') }}
              </p>
...
const props = defineProps<{ open: boolean; zIndex?: number; overlayId?: string; policy?: PolicyPayload | null; readOnly?: boolean }>()
