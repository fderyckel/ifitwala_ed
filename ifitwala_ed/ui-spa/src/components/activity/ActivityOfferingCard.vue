...
<template>
	<article class="card-surface p-5">
		<div class="mb-3 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
			<div>
				<p class="type-overline text-ink/60">{{ offering.school_abbr || offering.school_label }}</p>
		...
		<div class="mt-4 grid gap-3 md:grid-cols-2">
			<div class="rounded-xl border border-line-soft bg-surface-soft p-3">
				...
				<p class="mt-1 type-caption text-ink/80">
					{{ offering.activity_context.logistics_location_label || 'Location shared by school update' }}
				</p>
				<p v-if="offering.activity_context.logistics_pickup_instructions" class="type-caption text-ink/70">
					Pickup: {{ offering.activity_context.logistics_pickup_instructions }}
				</p>
				<p v-if="offering.activity_context.logistics_dropoff_instructions" class="type-caption text-ink/70">
