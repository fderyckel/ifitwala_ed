          ...
          <DialogPanel class="if-overlay__panel">
            ...
            <div class="if-overlay__body space-y-5">
              ...
              <section class="space-y-2">
                ...
                <div class="flex flex-wrap gap-2">
                  <button
                    ...
                    :class="evidenceType === option.value ? 'border-canopy bg-canopy/10 text-canopy' : 'border-slate-200 bg-white text-slate-token/70'"
              ...
              <section v-if="evidenceType === 'text'" class="space-y-2">
                <label class="type-caption text-slate-token/70" for="evidence-text">Evidence text</label>
                <textarea
                  id="evidence-text"
              ...
              <section v-else class="space-y-2">
                <label class="type-caption text-slate-token/70" for="evidence-link">Evidence link</label>
                <input
                  id="evidence-link"
...
const selectedStudents = ref<string[]>(
  (props.preselected_students || []).map((row) => row.student)
)
