...
<template>
  <div
    class="min-h-screen flex flex-col text-ink
           bg-gradient-to-b from-sand/90 via-surface-soft/95 to-white
           bg-[radial-gradient(circle_at_10%_0,rgb(var(--leaf-rgb)/0.10),transparent_55%)]"
  >
      ...
      <div class="mx-auto max-w-6xl px-4 py-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-col items-start gap-1 sm:items-end">
            ...
            <a href="/?cmd=web_logout" class="type-caption text-ink/70 hover:text-ink underline underline-offset-4">
              {{ __('Log out') }}
            </a>
          </div>
        </div>
    ...
    <div class="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8 flex-1">
      <div v-if="loading" class="rounded-3xl border border-border/70 bg-white px-6 py-10 shadow-soft">
      ...
      <div v-else-if="error" class="rounded-3xl border border-rose-200 bg-rose-50 px-6 py-6 shadow-soft">
