...
async function fetchGroups() {
	...
	try {
		...
		const { message } = await call('ifitwala_ed.api.student_groups.fetch_groups', payload);
...
async function fetchStudents(options: { reset?: boolean; append?: boolean } = {}) {
	...
	try {
		...
		const { message } = await call('ifitwala_ed.api.student_groups.fetch_group_students', payload);
