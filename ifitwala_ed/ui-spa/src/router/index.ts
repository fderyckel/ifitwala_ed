...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/staff/gradebook', name: 'staff-gradebook', component: () => import('@/pages/staff/gradebook/Gradebook.vue'), meta: { layout: 'staff' } },
	...
	{ path: '/staff/policy-library', name: 'staff-policy-library', component: () => import('@/pages/staff/StaffPolicies.vue'), meta: { layout: 'staff' } },
	{ path: '/staff/policies', redirect: { name: 'staff-policy-library' } },
