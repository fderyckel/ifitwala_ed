...
class TestOrgCommunication(FrappeTestCase):
    ...
    def test_organization_audience_allows_guardians(self):
        doc = frappe._dict(
            school=None,
            audiences=[
                frappe._dict(
    ...
    def test_draft_can_skip_incomplete_school_scope_audience(self):
        doc = frappe._dict(
            status="Draft",
            school=None,
            audiences=[
    ...
    def test_draft_skips_organization_audience_role_restrictions(self):
        doc = frappe._dict(
            status="Draft",
            audiences=[
                frappe._dict(
