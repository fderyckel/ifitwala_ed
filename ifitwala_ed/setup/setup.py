...
def create_roles_with_homepage():
    ...
    roles = [
        ...
        {"role_name": "Nurse", "desk_access": 1, "home_page": canonical_path_for_section("staff")},
        {"role_name": "Academic Admin", "desk_access": 1, "home_page": canonical_path_for_section("staff")},
        {"role_name": "Admission Officer", "desk_access": 1, "home_page": canonical_path_for_section("staff")},
        {"role_name": "Admission Manager", "desk_access": 1, "home_page": canonical_path_for_section("staff")},
    ]
