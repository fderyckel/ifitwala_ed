// Keep Program Offering Selection Window List view aligned with Report view.
//
...
frappe.listview_settings["Program Offering Selection Window"] = {
	onload(listview) {
		strip_program_offering_selection_window_title_joins(listview);
	},
	refresh(listview) {
		strip_program_offering_selection_window_title_joins(listview);
	},
...
function strip_program_offering_selection_window_title_joins(listview) {
	if (!listview || listview.__program_offering_selection_window_title_joins_stripped) return;

	const blocked_fields = new Set(["program_offering.offering_title as program_offering_offering_title"]);
	...
	listview.__program_offering_selection_window_title_joins_stripped = true;
}
