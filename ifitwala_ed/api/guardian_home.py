    ...
    for day in family_dates:
        ...
        for child in children:
            ...
            blocks = _dedupe_blocks(
                sorted(blocks, key=lambda b: (b.get("start_time"), b.get("end_time"), b.get("title")))
            )
    ...
    for event_row in event_rows:
        ...
        while current <= range_end:
            ...
            if date_key in date_keys:
                start_time = (
                    "00:00" if all_day else _coerce_time(start_dt, "school_event.start", debug_warnings) or "00:00"
                )
