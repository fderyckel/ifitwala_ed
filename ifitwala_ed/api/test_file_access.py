...
class TestFileAccessUrlContracts(FrappeTestCase):
    ...
    def test_download_guardian_file_redirects_to_drive_grant_for_linked_guardian(self):
        ...
        with (
            ...
            patch(
                ...
                return_value="https://signed.example.com/thumb_guardian.webp",
            ),
        ):
    ...
    def test_download_academic_file_redirects_supporting_material_to_drive_grant_for_scoped_student(self):
        file_row = {
            "name": "FILE-MAT-1",
        ...
        with (
            ...
            patch(
                "ifitwala_ed.api.file_access._resolve_drive_download_grant_url",
                return_value="https://signed.example.com/material.pdf",
            ),
        ):
            frappe.local.response = {}
            download_academic_file(
    ...
    def test_preview_academic_file_fails_closed_when_no_safe_preview_or_download_target_exists(self):
        file_row = {
            "name": "FILE-MAT-1",
            "file_url": "/private/files/Courses/COURSE-1/material.pdf",
            "file_name": "material.pdf",
        ...
        with (
            ...
            patch("ifitwala_ed.api.file_access._resolve_drive_download_grant_url", return_value=None),
        ):
            frappe.local.response = {}
    ...
    def test_thumbnail_academic_file_fails_closed_when_safe_thumb_target_is_unavailable(self):
        file_row = {
            "name": "FILE-MAT-1",
            "file_url": "/private/files/Courses/COURSE-1/material.png",
            "file_name": "material.png",
    ...
    def test_open_public_website_media_redirects_private_logo_to_drive_preview_for_guest(self):
        file_row = {
            "name": "FILE-PUBLIC-1",
    ...
    def test_open_public_website_media_fails_closed_without_safe_target(self):
        file_row = {
            "name": "FILE-PUBLIC-1",
            "file_url": "/private/files/Organization/root/logo.png",
            "file_name": "logo.png",
