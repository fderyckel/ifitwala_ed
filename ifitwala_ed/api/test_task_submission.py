...
class TestTaskSubmissionApi(FrappeTestCase):
    ...
    def test_get_latest_submission_serializes_governed_preview_and_open_urls(
        ...
        attachment = attachments[0].get("attachment") or {}
        secure_url = (attachment.get("open_url") or "").strip()
        ...
        preview_url = (attachment.get("preview_url") or "").strip()
        ...
        self.assertEqual(attachment.get("preview_status"), "ready")
        ...
        self.assertEqual(attachment.get("owner_doctype"), "Task Submission")
        self.assertEqual(attachment.get("owner_name"), "TSU-2026-00001")
        self.assertEqual(attachment.get("kind"), "pdf")
        self.assertTrue(attachment.get("is_latest_version"))
