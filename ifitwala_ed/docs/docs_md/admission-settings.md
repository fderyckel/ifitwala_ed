...
summary: "Define admissions SLA windows, assignment task color defaults, admissions-portal guardian visibility, and the admissions-to-enrollment auto-hydration policy."
...
`Admission Settings` is a Single DocType that stores operational defaults for admissions SLA deadlines, assignment ToDo styling, admissions portal profile surface toggles, and the admissions-to-enrollment auto-hydration policy.

## Authoritative Contract

[[fig:fig-1 size=auto]]

This doctype owns seven configuration fields:
...
6. Enrollment-request hydration remains request-only and post-student; this setting controls timing, not contract shape.
