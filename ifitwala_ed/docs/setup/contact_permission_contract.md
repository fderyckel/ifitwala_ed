...
- `ifitwala_ed/patches/sync_global_contact_access_permissions.py`
...
| Existing-site rollout | CRM permission sync patches | `patches/sync_core_crm_permissions.py`, `patches/sync_global_contact_access_permissions.py`, `patches.txt` | `patches/test_sync_core_crm_permissions.py`, `patches/test_sync_global_contact_access_permissions.py`, `setup/test_contact_permissions.py` |
