...
4. `07_year_rollover_architecture.md` — current rollover lanes, closure inventory, and explicit non-orchestrated gaps
5. `04_enrollment_examples.md` — non-normative scenarios and stress tests
6. `05_course_choice_semantics.md` — implemented basket-group and choice-row semantics
7. `06_activity_booking_architecture.md` — sibling architecture for activity booking
