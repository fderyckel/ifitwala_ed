  ...
  <section class="grid grid-cols-1 gap-4 lg:grid-cols-2">
    <div class="card-surface p-4 space-y-3">
      ...
      <div class="space-y-2">
        ...
        <div v-if="!notes.length" class="rounded-xl border border-dashed border-slate-200 bg-white/80 px-3 py-3">
    ...
    <div class="card-surface p-4 space-y-3">
      ...
      <div class="space-y-2">
        ...
        <div v-if="!tasks.length" class="rounded-xl border border-dashed border-slate-200 bg-white/80 px-3 py-3">
