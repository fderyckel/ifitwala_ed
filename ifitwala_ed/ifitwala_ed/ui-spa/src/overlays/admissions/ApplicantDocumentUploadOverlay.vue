        ...
        >
          <DialogPanel class="if-overlay__panel">
            ...
            <div class="if-overlay__body px-6 pb-6 space-y-5">
              ...
              <div class="rounded-2xl border border-dashed border-border/70 bg-white px-4 py-4 shadow-soft">
                <input
                  ref="fileInput"
                  type="file"
            ...
            <div class="if-overlay__footer px-6 pb-6 flex flex-wrap items-center justify-between gap-3">
              <p class="type-caption text-ink/55">
                {{ isReadOnly ? __('This application is read-only.') : __('Uploads are reviewed by admissions staff.') }}
              </p>
