          ...
          <DialogPanel class="if-overlay__panel">
            ...
            <div class="if-overlay__footer px-6 pb-6 flex flex-wrap items-center justify-between gap-3">
              <p class="type-caption text-ink/55">
                {{ isReadOnly ? __('This application is read-only.') : __('You can update this later if needed.') }}
              </p>
...
const props = defineProps<{ open: boolean; zIndex?: number; overlayId?: string; initial?: HealthPayload | null; readOnly?: boolean }>()
