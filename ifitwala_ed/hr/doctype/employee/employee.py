...
from ifitwala_ed.utilities.image_utils import get_employee_user_avatar_url
...
def _refresh_runtime_bindings():
    ...
    global get_descendant_organizations, get_user_base_org, get_employee_user_avatar_url
    ...
    from ifitwala_ed.utilities.image_utils import get_employee_user_avatar_url as current_get_employee_user_avatar_url
    from ifitwala_ed.utilities.school_tree import get_school_lineage as current_get_school_lineage
    ...
    get_employee_user_avatar_url = current_get_employee_user_avatar_url
...
class Employee(NestedSet):
    ...
    def update_user(self):
        ...
        # ---- image sync -------------------------------------------------------
        avatar_url = get_employee_user_avatar_url(self.name, original_url=self.employee_image)
