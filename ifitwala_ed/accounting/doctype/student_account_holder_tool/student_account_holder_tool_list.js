// Keep Student Account Holder Tool List view aligned with Report view.
//
...
frappe.listview_settings["Student Account Holder Tool"] = {
	onload(listview) {
		strip_student_account_holder_tool_title_joins(listview);
	},
	refresh(listview) {
		strip_student_account_holder_tool_title_joins(listview);
	},
...
function strip_student_account_holder_tool_title_joins(listview) {
	if (!listview || listview.__student_account_holder_tool_title_joins_stripped) return;
	...
	listview.__student_account_holder_tool_title_joins_stripped = true;
}
