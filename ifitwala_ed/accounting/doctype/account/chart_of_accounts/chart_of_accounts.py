...
def create_charts(
    organization, chart_template=None, existing_organization=None, custom_chart=None, from_coa_importer=None
):
                    ...
                    account = frappe.get_doc(
                        {
                            ...
                            or frappe.get_cached_value("Organization", organization, "default_currency"),
...
def get_charts_for_country(country, with_standard=False):
    ...
    def _get_chart_name(content):
        if content:
            ...
            if (content and content.get("disabled", "No") == "No") or frappe.local.flags.allow_unverified_charts:
