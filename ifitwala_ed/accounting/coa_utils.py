...
def ensure_accounts_settings(organization):
	...
	defaults = {
		"default_receivable_account": get_account_by_type(
			organization, "Receivable", root_type="Asset"
		),
		...
		"default_tax_payable_account": get_account_by_type(
			organization, "Tax", root_type="Liability"
		),
	}
	...
	missing = [
		...
		if not value and key != "default_advance_account"
	]
	if missing:
		frappe.throw(
